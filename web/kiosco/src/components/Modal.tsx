    ...
    <AnimatePresence>
      {open && (
        ...
        >
          ...
          >
            <div className="w-24 h-24 mx-auto mb-4 rounded-full bg-verde-500/20 flex items-center justify-center">
              <svg className="w-12 h-12 text-verde-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
              </svg>
            </div>
            <h3 className="font-sans text-[length:var(--fs-section)] text-verde-900 mb-1 font-bold">¡Reserva confirmada!</h3>
            <p className="text-[length:var(--fs-body)] text-verde-700/70 mb-6">Tu habitación está lista</p>
            <div className="bg-crema rounded-2xl border-l-4 border-verde-600 p-4 text-left space-y-3 text-[length:var(--fs-body)]">
            ...
            <motion.button
              whileTap={{ scale: 0.96 }}
              onClick={onClose}
              className="mt-6 w-full bg-verde-900 text-white rounded-2xl py-3 font-extrabold text-[length:var(--fs-body)] shadow-soft hover:bg-verde-700 transition-colors"
            >
              Cerrar
            </motion.button>
          </motion.div>
