...
const s = StyleSheet.create({
  ...
  form: {},
  label: { fontSize: 16, fontWeight: '600', color: colors.brandPrimary, marginBottom: spacing.sm, letterSpacing: 1 },
  input: { borderWidth: 1.5, borderColor: colors.border, borderRadius: radii.button, paddingHorizontal: spacing.md, paddingVertical: 16, fontSize: sizes.input, color: colors.brandPrimary, backgroundColor: colors.white },
  ...
  cta: { backgroundColor: colors.brandPrimary, borderRadius: radii.button, paddingVertical: 20, alignItems: 'center' },
  ctaDis: { opacity: 0.4 },
